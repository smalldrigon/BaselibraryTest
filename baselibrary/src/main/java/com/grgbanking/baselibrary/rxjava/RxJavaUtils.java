...
import com.grgbanking.baselibrary.rxjava.impl.IActionCallBack;
import com.grgbanking.baselibrary.rxjava.subscriber.BaseSubscriber;
import com.grgbanking.baselibrary.rxjava.subscriber.SimpleThrowableAction;
import com.grgbanking.baselibrary.rxjava.task.RxAsyncTask;
import com.grgbanking.baselibrary.rxjava.task.RxIOTask;
import com.grgbanking.baselibrary.rxjava.task.RxIteratorTask;
import com.grgbanking.baselibrary.rxjava.task.RxUITask;
import io.reactivex.*;
...
public final class RxJavaUtils {
    ...
    public static <T, R> Disposable executeAsyncTask2(@NonNull T t, @NonNull Function<T, R> func1, @NonNull BaseSubscriber<R> subscriber) {
        return executeAsyncTask2(t, func1).subscribe(subscriber);
    }
    ...
    public static <R> Disposable executeAsyncTask2(@NonNull Function<Integer, R> func1, @NonNull BaseSubscriber<R> subscriber) {
        return executeAsyncTask2(func1).subscribe(subscriber);
    }
    ...
    public static Observable<Object> doActiononIoThread(IActionCallBack callBack) {
        return Observable.create(emitter -> emitter.onNext(callBack.doAction())).
                subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread());
    }

    public static Observable<Object> doActiononMainThread(IActionCallBack callBack) {
        return Observable.create(emitter -> emitter.onNext(callBack.doAction())).
                subscribeOn(AndroidSchedulers.mainThread()).
                observeOn(AndroidSchedulers.mainThread());
    }

//    fun doActiononIoThread(action: () -> Any): Observable<Any> {
